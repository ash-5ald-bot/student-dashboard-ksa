...
const PRESET_EVENTS=[
{id:"acad-start-admin",title:"عودة الهيئة الإدارية والمشرفين",type:"school",date:"2026-08-11",end:"2026-08-11",source:"التقويم الدراسي 1448-1449 هـ",notes:"حدث دراسي قابل للتعديل"},
{id:"acad-teachers",title:"عودة المعلمين",type:"school",date:"2026-08-16",end:"2026-08-16",source:"التقويم الدراسي 1448-1449 هـ",notes:"حدث دراسي قابل للتعديل"},
{id:"acad-start",title:"بداية العام الدراسي 1448-1449 هـ",type:"school",date:"2026-08-23",end:"2026-08-23",source:"وزارة التعليم/تقويم دراسي",notes:"للتقويم العام. بعض المدن قد تختلف حسب الإعلان الرسمي."},
{id:"national-day",title:"إجازة اليوم الوطني السعودي",type:"national",date:"2026-09-23",end:"2026-09-26",source:"مناسبة وطنية سعودية",notes:"اليوم الوطني 23 سبتمبر"},
{id:"autumn-break",title:"إجازة الخريف",type:"holiday",date:"2026-11-20",end:"2026-11-28",source:"التقويم الدراسي 1448-1449 هـ",notes:"إجازة دراسية"},
{id:"midyear-break",title:"إجازة منتصف العام",type:"holiday",date:"2027-01-08",end:"2027-01-16",source:"التقويم الدراسي 1448-1449 هـ",notes:"إجازة دراسية"},
{id:"ramadan",title:"بداية رمضان 1448 هـ",type:"ramadan",date:"2027-02-08",end:"2027-02-08",source:"تقويم أم القرى",notes:"تقويميًا؛ الإعلان النهائي حسب الرؤية"},
{id:"last10",title:"العشر الأواخر من رمضان",type:"ramadan",date:"2027-02-27",end:"2027-03-08",source:"تقويم أم القرى",notes:"تقويميًا؛ الإعلان النهائي حسب الرؤية"},
{id:"founding",title:"إجازة يوم التأسيس",type:"national",date:"2027-02-19",end:"2027-02-22",source:"يوم التأسيس/التقويم الدراسي",notes:"يوم التأسيس 22 فبراير"},
{id:"fitr-school",title:"إجازة عيد الفطر للمدارس",type:"eid",date:"2027-02-26",end:"2027-03-13",source:"التقويم الدراسي 1448-1449 هـ",notes:"قد تتغير حسب الرؤية والإعلان الرسمي"},
{id:"eid-fitr",title:"عيد الفطر المبارك 1448 هـ",type:"eid",date:"2027-03-09",end:"2027-03-11",source:"تقويم أم القرى",notes:"تقويميًا؛ الإعلان النهائي حسب الرؤية"},
{id:"adha-school",title:"إجازة عيد الأضحى للمدارس",type:"eid",date:"2027-05-07",end:"2027-05-22",source:"التقويم الدراسي 1448-1449 هـ",notes:"قد تتغير حسب الرؤية والإعلان الرسمي"},
{id:"arafah",title:"يوم عرفة 1448 هـ",type:"eid",date:"2027-05-16",end:"2027-05-16",source:"تقويم أم القرى",notes:"تقويميًا؛ الإعلان النهائي حسب الرؤية"},
{id:"eid-adha",title:"عيد الأضحى المبارك 1448 هـ",type:"eid",date:"2027-05-17",end:"2027-05-20",source:"تقويم أم القرى",notes:"تقويميًا؛ الإعلان النهائي حسب الرؤية"},
{id:"year-end",title:"بداية إجازة نهاية العام",type:"holiday",date:"2027-06-24",end:"2027-06-24",source:"التقويم الدراسي 1448-1449 هـ",notes:"بداية إجازة نهاية العام الدراسي"}
];

const DEFAULTS={
theme:"blue",active:"dashboard",query:"",calendarMode:"year",calendarYear:2026,calendarMonth:7,
subjects:[
...
function shell(content){
 ...
 app.innerHTML=`<div class="app">
  <aside class="sidebar">
   ...
   <div class="pro-panel"><span class="eyebrow">AI READY</span><h3>مساعد دراسي ذكي</h3><p>المرحلة القادمة: إدخال صوتي/نصي يحول الكلام إلى مهام وخطة مذاكرة تلقائية.</p></div>
  </aside>
  <main class="main">
   <header class="top">
    <section class="hero">
     <div class="hero-inner">
      <div>
       ...
       <h2>${pageTitle()}</h2>
       <p>كل ما يحتاجه الطالب في شاشة واحدة: تقويم دراسي، واجبات، اختبارات، مواد، رمضان، الأعياد والمناسبات السعودية بتصميم premium قابل للبيع.</p>
       <div class="hero-actions"><button class="btn" id="quickAdd">+ إضافة سريعة</button><button class="btn ghost" id="themeBtn">${state.theme==="blue"?"🌸 ثيم وردي":"🔵 ثيم أزرق"}</button><button class="btn ghost" id="goCalendar">📅 افتح التقويم</button></div>
      </div>
      <div class="focus-card">
       ...
       <div class="focus-next"><small>القادم</small><b>${n?esc(n.title):"لا توجد أحداث قادمة"}</b><div class="muted small">${n?`${diff(n.date)} يوم • ${label(n.type)}`:""}</div></div>
      </div>
     </div>
    </section>
    <div class="toolrow">
...
function dashboard(){
 ...
 return`<div class="grid stats">${stat("⚠️","أقرب اختبار",exam?`${diff(exam.date)} يوم`:"لا يوجد",exam?.title)}${stat("🏖️","أقرب إجازة",hol?`${diff(hol.date)} يوم`:"لا يوجد",hol?.title)}${stat("🕌","رمضان 1448",ram?`${diff(ram.date)} يوم`:"مدخل",ram?.title)}${stat("✅","مهام نشطة",state.tasks.filter(t=>t.status!=="done").length,"واجبات واختبارات")}</div>
...
window.restoreEvents=()=>{const ids=new Set(state.events.map(e=>e.id));PRESET_EVENTS.forEach(e=>{if(!ids.has(e.id))state.events.push({...e})});save();toast("تمت استعادة الأحداث الرسمية");render()}
